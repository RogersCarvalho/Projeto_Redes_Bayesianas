...
public class K2Old 
	...
	/** Holds number of times that g function is called. */
	int gFunctionCounter;
	...
	public void setGFunctionCounter(int _gFunctionCounter) {
		gFunctionCounter = _gFunctionCounter;
	}
